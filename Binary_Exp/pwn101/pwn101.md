...
![main](challenge1/chal1_main_logic.png)

- Entering more characters than the input_buffer accepts will overwrite the preset_value.

![flag](challenge1/chal1_flag.png)

### Challenge 2
- Interacting with the binary

![interact](challenge2/chal2_initial.png)

- Checksec on the binary

![checksec](challenge2/chal2_checksec.png)
...
![main](challenge2/cha2_main_logic.png)
